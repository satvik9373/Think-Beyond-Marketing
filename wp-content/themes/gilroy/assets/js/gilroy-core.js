...
(function($) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        window.addEventListener('load', function() {
            ...
            h1tl.fromTo(".gly-hero-1-title .gly-gd-color-1", {
            ...
            h2tl.from(".gly-hero-2-il-3", {
                y: 200,
                duration: 1
            });
            h2tl.from(".gly-hero-2-title", {
                scale: 1.3,
                y: 100,
                opacity: 0,
                stagger: .5,
            ...
            h2tl.fromTo(".gly-hero-2-title .gly-gd-color-1", {
                clipPath: "polygon(0 0, 0 0, 0 100%, 0% 100%)"
            }, {
                clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)"
            });
            h2tl.from(".gly-hero-2-il-2", {
                y: 200,
                opacity: 0
            });
            h2tl.from(".gly-hero-2-il-1", {
                y: -200,
                opacity: 0
            });
            h2tl.from(".gly-project-2-area", {
                y: 200,
                opacity: 0
            });
            ...
            h3tl.from(".gly-hero-3-demo-row", {
                opacity: 1,
                duration: 2
            });
            h3tl.from(".h3-fadebttm", {
                y: "-=100",
                opacity: 0,
                stagger: .2,
                duration: 1
    ...
    gtbp1.from(".gly-services-1-icon-wrap", {
        rotateZ: -200,
        duration: 1
    })
    gtbp1.from(".gly-services-1-icon-3", {
        scale: 0,
    }, "<")
    gtbp1.from(".gly-services-1-icon-2", {
        scale: 0,
    }, "<=.1")
    gtbp1.from(".gly-services-1-icon-1", {
        scale: 0,
    }, "<=.1")
    gtbp1.from(".gly-services-1-img img", {
        scale: 1.5,
        duration: 1
    }, "<")
    ...
    glypr1.from(".gly-project-1-curlc-icon svg", {
        rotateZ: 360,
        duration: 1
    })
    glypr1.from(".gly-project-1-curlc-icon i", {
        yPercent: 100,
        xPercent: -100,
        duration: 1
    }, "<")
    ...
    glyt2g.fromTo(".gly-earth img", {
        filter: "drop-shadow(0px 0px  0px #1667A9)",
        duration: 1
    }, {
    ...
    glyf2g.from(".gly-footer-2-area", {
            yPercent: 20,
            duration: 1
        })
        .from(".gly-footer-2-il-1", {
            yPercent: -20,
            xPercent: 20,
            duration: 1
        }, "<.3")
        .from(".gly-footer-2-il-2", {
            yPercent: 20,
            xPercent: -20,
            duration: 1
        }, "<.3")
        .from(".gly-footer-2-top-line", {
            scaleX: .5,
            duration: 1
        }, "<")
    ...
    glyf3g.from(".gly-portfolio-3-item-wrap", {
            xPercent: 100,
            duration: 1
        })
        .from(".gly-portfolio-3-bg-shape", {
            xPercent: 100,
            duration: 1
        }, "<=.5")
    ...
    glyabut3g.from(".gly-about-3-shape-1", {
        scaleX: 0,
        duration: 1
    })
    ...
    glyt3g.from(".gly-testimonial-3-bg-img img", {
        yPercent: 100,
        duration: 1
    })
    ...
    glyc3g.from(".gly-campaign-3-img", {
        xPercent: 100,
        stagger: .2,
        duration: 1
    })
    ...
    glyaw3g.from(".gly-award-3-img img", {
        yPercent: 100,
        stagger: .2,
        duration: 1
    })
    ...
    glyct4g.from(".gly-expi-count-4-area", {
        yPercent: 100,
        duration: 1
    })
    ...
    glycam4g.from(".gly-campaign-4-bg-img", {
        scale: 0,
        duration: 1
    })
    glycam4g.from(".gly-campaign-4-img", {
        yPercent: 100,
        duration: 1
    })
    ...
    glyprice4g.from(".gly-price-4-bg-shape", {
        y: "100%",
        duration: 1
    })
    glyprice4g.from(".gly-price-4-bg-img img", {
        y: "100%",
        duration: 1
    })
